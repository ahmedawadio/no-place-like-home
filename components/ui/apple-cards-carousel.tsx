    ...
    >
      ...
      <div className=" w-screen">
        ...
        >
          ...
          <div
            className={cn(
              "flex flex-row justify-start gap-4 pl-0 pr-40",
              "max-w-7xl mx-auto" // remove max-w-4xl if yu want the carousel to span the full width of its container
            )}
          >
        ...
        <div className="flex justify-end gap-2 mr-10 w-full">
          <button
...
export const Card = ({
  ...
  useEffect(() => {
    ...
    if (open) {
      document.body.style.overflow = "hidden"; // Prevent scrolling in the background when modal is open
    } else {
